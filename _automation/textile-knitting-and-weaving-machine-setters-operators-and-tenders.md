...
* Robotics company [SoftWear Automation][2] has created a robot that can produce 17 times as many t-shirts in an hour as a human.[^2]
* Adidas is using robots to make sneakers—even _custom_ sneakers—90 times faster than it can currently. [^3]

[^1]:	[Impact of automation on developing countries puts up to 85% of jobs at risk][1]

[^2]:	[New t-shirt sewing robot can make as many shirts per hour as 17 factory workers][3]

[^3]:	[Inside the Adidas Factory That Uses Robots to Build Running Shoes][4]

[1]:	http://www.oxfordmartin.ox.ac.uk/news/201601_Technology_at_Work_2
[2]:	http://softwearautomation.com/
[3]:	http://ift.tt/2vEk3sv
[4]:	http://ift.tt/2xk6fIq
