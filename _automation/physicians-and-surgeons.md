...
* Kardia (a portable EKG) by [AliveCor][1] catches four times as many [atrial fibrillation][2] cases as traditional screening, which has been proven in multiple studies.[^1]
...
* [VisualDx][6] is an app that uses Apple’s Core ML to help non-dermatologist doctors diagnose lesions, rashes and other skin conditions.[^4] (It’s logical that this would cut down on referrals to dermatologists, so it would be great to see some studies of this eventually.)
* At a TechCrunch Disrupt hackathon in September 2017, developers created an app called “Doctor Hazel” that uses artificial intelligence to determine whether a skin condition is skin cancer.[^5] The speed with which they created the app shows how powerful and accessible AI technology is now. The biggest limiting factor is access to data, the developers say, but such data is already being crowdsourced by users for apps such as [SkinVision][9].

## General medicine

* A number of companies are working to automate aspects of general medicine, _especially_ diagnosis, which relies on the power of machine learning to identify patterns in huge amounts of data—data that’s growing rapidly through growth in adoption of electronic health records.
...
[^1]:	[AliveCor catches four times as many AFib cases as traditional screening in year-long study][3]

[^2]:	[Cardiologist-Level Arrhythmia Detection with Convolutional Neural Networks][4]

[^3]:	[Microsoft, Google Beat Humans at Image Recognition][5]

[^4]:	[VisualDx app to debut with Apple iOS 11, helping non-dermatologist doctors diagnose skin conditions][7]

[^5]:	[Doctor Hazel uses AI to try to determine if you have skin cancer][8]

[^6]:	[Artificial intelligence beats doctors at diagnosing certain diseases][10]

[^7]:	[Athelas launches an Echo-like blood testing device for the home][11]

[^8]:	[Neural Machine Translation between Herbal Prescriptions and Diseases][12]

[^9]:	[This new smartphone app can detect early signs of pancreatic cancer using selfies][13]

[^10]:	[Artificial intelligence better than scientists at choosing successful IVF embryos][14]

[^11]:	[1 in 4 prostate cancer units shut as patients flock to robot surgeons][15]

[1]:	https://www.alivecor.com/
[2]:	https://en.wikipedia.org/wiki/Atrial_fibrillation
[3]:	http://ift.tt/2vNtdHq
[4]:	https://arxiv.org/abs/1707.01836
[5]:	http://www.eetimes.com/document.asp?doc_id=1325712
[6]:	https://www.visualdx.com/
[7]:	http://ift.tt/2gmtqdx
[8]:	http://ift.tt/2wpRDHa
[9]:	https://skinvision.com/
[10]:	http://www.chinadaily.com.cn/business/tech/2017-08/21/content_30900979.htm
[11]:	http://ift.tt/2wGbtNL
[12]:	https://arxiv.org/abs/1707.02575
[13]:	http://ift.tt/2vob9TL
[14]:	http://www.independent.co.uk/news/health/ai-ivf-embryos-better-scientists-selection-a7823736.html
[15]:	http://ift.tt/2fQ8BqT